<%@ Page Title="" Language="C#" MasterPageFile="~/AddUpdateSite.Master" AutoEventWireup="true" CodeBehind="DodajProjekt.aspx.cs" Inherits="Aplikacija_za_administraciju.EntityForms.DodajProjekt" %>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-sm-6">
                ...
                <div class="form-group d-flex">
                    <asp:Button Text="Spremi" CssClass="btn btn-success m-auto" runat="server" OnClick="DodajProjekt_Click" />
                </div>
            </div>
        </div>
    </div>
